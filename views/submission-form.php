...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" action="">
		...
		<fieldset class="usp-title">
			<label for="user-submitted-title"><?php esc_html_e('Story Title', 'usp'); ?></label>
			<input id="user-submitted-title" name="user-submitted-title" type="text" value="" placeholder="<?php esc_attr_e('Story Title', 'usp'); ?>"<?php if (usp_check_required('usp_title')) echo $usp_required; ?> class="usp-input">
		</fieldset>
		<?php } if ($usp_options['usp_tags'] == 'show' || $usp_options['usp_tags'] == 'optn') { ?>
		<?php if ($usp_existing_tags) { ?>
		
		<fieldset class="usp-tags">
			<label for="user-submitted-tags"><?php esc_html_e('Story Tags', 'usp'); ?></label>
		...
		<fieldset class="usp-tags">
			<label for="user-submitted-tags"><?php esc_html_e('Story Tags', 'usp'); ?></label>
			<input id="user-submitted-tags" name="user-submitted-tags" type="text" value="" placeholder="<?php esc_attr_e('Story Tags', 'usp'); ?>"<?php if (usp_check_required('usp_tags')) echo $usp_required; ?> class="usp-input">
		</fieldset>
		<?php } ?>
		...
		<fieldset class="usp-category">
			<label for="user-submitted-category"><?php esc_html_e('Story Category', 'usp'); ?></label>
		...
		<fieldset class="usp-content">
			...
			<label for="user-submitted-content"><?php esc_html_e('Story Content', 'usp'); ?></label>
			<textarea id="user-submitted-content" name="user-submitted-content" rows="5" placeholder="<?php esc_attr_e('Remember: No links allowed!', 'usp'); ?>"<?php if (usp_check_required('usp_content')) echo $usp_required; ?> class="usp-textarea"></textarea>
			<?php } ?>
		...
		<div id="usp-submit">
			...
			<?php // --- Conditionally display Cloudflare Turnstile --- ?>
            <?php if ($usp_turnstile_enable && !empty($usp_turnstile_site_key)) : ?>
                <div class="cf-turnstile" data-sitekey="<?php echo esc_attr($usp_turnstile_site_key); ?>" data-theme="light"></div>
            <?php elseif ($usp_turnstile_enable && empty($usp_turnstile_site_key)) : ?>
                <div class="usp-error"><?php esc_html_e('Turnstile is enabled but the Site Key is missing in plugin settings.', 'usp'); ?></div>
            <?php endif; ?>
